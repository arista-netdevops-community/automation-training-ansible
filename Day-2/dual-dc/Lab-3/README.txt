...
4)  Now, we're going to apply (roughly) configurations you did to customize your devices in Day 2 Lab 2, but by using CVP, not direct eAPI calls.
...
4a) Customized, per device login banner using Jinja template files and eos_facts from devices.
    The templates have been provided for you (same as Day 2 Lab 2)

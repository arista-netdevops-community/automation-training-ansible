...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_DC1-LEAF4_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-LEAF4_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.18.255.9/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | 1500 | routed | access | - | - | - | 172.18.255.11/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-LEAF4_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | server02_Ethernet1 | *1500 | *switched | *trunk | *120-211 | - | - | - | 4 | active |
| Ethernet5 | MLAG_PEER_DC1-LEAF4_Ethernet5 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-LEAF4_Ethernet3
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.255.23.5/32 |
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.255.23.5 |

### Virtual Router MAC Address Device and Virtual Source NAT Configuration

```eos
ip virtual-router mac-address 00:dc:00:00:00:0a
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.255.23.5
!
```

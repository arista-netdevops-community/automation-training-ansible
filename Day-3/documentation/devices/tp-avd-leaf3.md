...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.83.13.216/24 | 10.83.13.1 |
...
| --------- | --------------- | ------------ | --------- |
| TP_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_tp-avd-leaf4_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | server02_Ethernet1 | *trunk | *120-212 | *- | *- | 4 |
| Ethernet5 | MLAG_PEER_tp-avd-leaf4_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_TP-AVD-SPINE1.TST_Ethernet3 | routed | - | 172.18.255.9/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_TP-AVD-SPINE2_Ethernet3 | routed | - | 172.18.255.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_TP-AVD-SPINE1.TST_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_TP-AVD-SPINE2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_tp-avd-leaf4_Ethernet3
   no shutdown
...
!
interface Ethernet5
   description MLAG_PEER_tp-avd-leaf4_Ethernet5
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_tp-avd-leaf4_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_tp-avd-leaf4_Po3
   no shutdown
   switchport
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.255.23.3/32 |
...
| 172.18.255.8 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 172.18.255.10 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| Tenant_A_VMOTION | 192.168.255.3:50160 | 50160:50160 | - | - | learned | 160 |
| Tenant_A_WEB_Zone | 192.168.255.3:11 | 11:11 | - | - | learned | 120-122 |

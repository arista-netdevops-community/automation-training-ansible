...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.83.13.217/24 | 10.83.13.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_DC1-LEAF3_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |
| Port-Channel4 | server02_PortChannel1 | 1500 | switched | trunk | 120-211 | - | 4 | - | - |

### Port-Channel Interfaces Device Configuration

```eos
interface Port-Channel3
   description MLAG_PEER_DC1-LEAF3_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | 1500 | routed | access | - | - | - | 172.18.255.13/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | 1500 | routed | access | - | - | - | 172.18.255.15/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-LEAF3_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | server02_Ethernet2 | *1500 | *switched | *trunk | *120-211 | - | - | - | 4 | active |
| Ethernet5 | MLAG_PEER_DC1-LEAF3_Ethernet5 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-LEAF3_Ethernet3
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.255.23.6/32 |
...
| --------- | ----------- | --- | ---------- | ------- | -------------------- | ------- |
| Vlan110 | Tenant_A_OP_Zone_1 | Tenant_A_OP_Zone  | 10.12.10.1/24 | True | - | - |
| Vlan111 | Tenant_A_OP_Zone_2 | Tenant_A_OP_Zone  | 10.12.11.1/24 | True | - | - |
...
| Vlan140 | Tenant_A_DB_BZone_1 | Tenant_A_DB_Zone  | 10.12.40.1/24 | True | - | - |
| Vlan141 | Tenant_A_DB_Zone_2 | Tenant_A_DB_Zone  | 10.12.41.1/24 | True | - | - |
| Vlan210 | Tenant_B_OP_Zone_1 | Tenant_B_OP_Zone  | 10.20.11.1/24 | True | - | - |
| Vlan211 | Tenant_B_OP_Zone_2 | Tenant_B_OP_Zone  | 10.20.21.1/24 | True | - | - |
| Vlan310 | Tenant_C_OP_Zone_1 | Tenant_C_OP_Zone  | 10.30.10.1/24 | True | - | - |
| Vlan311 | Tenant_C_OP_Zone_2 | Tenant_C_OP_Zone  | 10.30.11.1/24 | True | - | - |
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.255.23.6 |

### Virtual Router MAC Address Device and Virtual Source NAT Configuration

```eos
ip virtual-router mac-address 00:dc:00:00:00:0a
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.255.23.6
!
```
...
mlag configuration
   ...
   peer-address heartbeat 10.83.13.216 vrf MGMT

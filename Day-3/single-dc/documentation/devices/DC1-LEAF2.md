...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.83.13.215/24 | 10.83.13.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_DC1-LEAF1_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-LEAF1_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.18.255.5/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.18.255.7/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-LEAF1_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | server01_Ethernet2 | *1500 | *switched | *trunk | *120-211 | - | - | - | 4 | active |
| Ethernet5 | MLAG_PEER_DC1-LEAF1_Ethernet5 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-LEAF1_Ethernet3
...
mlag configuration
   ...
   peer-address heartbeat 10.83.13.214 vrf MGMT
